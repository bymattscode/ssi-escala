...
export const Route = createFileRoute("/avaliacao-mensal")({
  component: AvaliacaoMensalPage,
});

function AvaliacaoMensalPage() {
  return (
    <div className="flex flex-col gap-6 max-w-7xl mx-auto w-full animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mt-0.5">
              Módulo de avaliação e acompanhamento mensal dos membros.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-card border border-border/70 rounded-2xl p-12 flex flex-col items-center justify-center text-center min-h-[300px]">
        ...
        <p className="text-sm text-muted-foreground mt-1 max-w-md">
          Este espaço está reservado para a construção futura da Avaliação Mensal.
        </p>
      </div>
    </div>
  );
